<?php
   ...
   make_class_average_good(554);
   make_class_average_good(779);
echo "success";
...
//Helper functions
   ...
   function make_class_average_good($class_id)
   {
   ...
   function boost_sub_activity_mark($sub_activity_id,$max_mark)
   {
      ...
      $sql = "select Mark,StudentId from subactivitymark where  SubActivityId='$sub_activity_id'";
      ...
      $marks_details = array();
       ...
       foreach ($marks_details as $student_detail) {
        ...
        $min_num = ceil(8*$max_mark/10);
         $mark = get_random_number($min_num,$max_mark);
   ...
   {
      //$boundary_mark = ceil($max_mark/2);
      $sql = "select Mark,StudentId from activitymark where ActivityId='$activity_id'";
   ...
   {
      //$boundary_mark = ceil(6*$max_mark/10);
      $sql = "select Mark,StudentId from marks where  ExamId='$exam_id' and SubjectId='$subject_id'";
