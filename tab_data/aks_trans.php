...
while(1)
{
    ...
    $date = date("Y-m-d");
    $time="";
    echo "Fetching from Table Queuetransaction ...\n";
    $te1="select * from queue_transaction where Status=0 order by DateTime Asc";
    ...
    if($numrows>0)
    {
        while($a=mysql_fetch_assoc($q))
        {
            if($a['SchoolId']==70){
                ...
                $sql="update queue_transaction set Status=1 where Status=0 and SchoolId=70 and DateTime='$datetime'";
                ...
                $te2="update queue_transaction set Status=1 where Status='0' and SchoolId='$schoolid' and DateTime='$datetime'";
...
// curl_init..( new session)
                ...
                $te2="delete from queue_transaction where SchoolId='$schoolid' and Status=1 and DateTime='$datetime'";
//$q2=mysql_query($te2,$con);
