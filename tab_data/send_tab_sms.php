...
$con=mysql_pconnect("localhost","root","bhuvanbanyan2109");
if(!$con)
{
    ...
    if($numrows>0)
    {
        while($a=mysql_fetch_assoc($q))
        {
            if($a['SchoolId']==70){
                ...
                $sql="update queue set Status=1 where Status=0 and SchoolId=70 and DateTime='$datetime'";
                ...
                $te2="update queue set Status=1 where Status='0' and SchoolId='$schoolid' and DateTime='$datetime'";
...
// curl_init..( new session)
                ...
                $te2="delete from queue where SchoolId='$schoolid' and Status=1 and DateTime='$datetime'";
//$q2=mysql_query($te2,$con);
